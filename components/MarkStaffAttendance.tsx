    ...
    const startCamera = useCallback(async () => {
        ...
        try {
            ...
            if (videoRef.current) {
                ...
                // Some browsers need a delay or explicit play call
            ...
            if (err.name === 'NotAllowedError' || err.name === 'PermissionDeniedError') {
                ...
                setError("Could not access camera. Try the 'Upload Photo' option instead.");
            }
        }
    }, [facingMode, stream]);
                                ...
                                {stream ? (
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-400 p-6 text-center">
                                        ...
                                        <div className="flex flex-col items-center gap-3">
                                            <button 
                                                onClick={startCamera}
                                                className="px-8 py-4 bg-indigo-600 text-white rounded-2xl text-[11px] font-black uppercase tracking-widest hover:scale-105 transition-transform flex items-center gap-3 shadow-xl shadow-indigo-200"
                                            >
