                            ...
                            <div className="relative aspect-video bg-gray-100 dark:bg-gray-900 rounded-3xl overflow-hidden border-4 border-gray-50 dark:border-gray-800 shadow-inner group">
                                {stream ? (
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-400">
                                        ...
                                        <button 
                                            onClick={startCamera}
                                            className="px-6 py-2 bg-indigo-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:scale-105 transition-transform"
                                        >
                                            Turn On Camera
                                        </button>
                                    </div>
                                ...
                                {stream && (
                                    <button 
                                        ...
                                        className="absolute bottom-4 left-1/2 -translate-x-1/2 w-16 h-16 bg-white rounded-full border-4 border-indigo-600 shadow-xl flex items-center justify-center group-active:scale-90 transition-transform"
                                    >
