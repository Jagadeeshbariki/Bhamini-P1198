...
const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (success) {
            ...
            setError('Invalid credentials. Note: Usernames are case-sensitive.');
        }
    };
        ...
        <div className="flex items-center justify-center py-12">
            <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div className="relative">
                            ...
                            <button
                                ...
                                className="absolute inset-y-0 right-0 z-20 pr-3 flex items-center text-sm leading-5 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-none"
                            ...
                            >
                                {isPasswordVisible ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                      ...
                                      <path d="M12.454 16.697L9.75 13.992a4 4 0 01-3.742-3.741L2.335 6.578A10.005 10.005 0 00.458 10c1.274 4.057 5.065 7 9.542 7 1.852 0 3.572-.544 5.026-1.499l-2.615-2.615z" />
                                    </svg>
                                ) : (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    {error && (
                        <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded text-xs text-red-600 dark:text-red-400 text-center border border-red-200 dark:border-red-800">
                            {error}
                        </div>
                    )}
                    ...
                    <div className="space-y-4">
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-bold rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-blue-400 dark:focus:ring-offset-gray-800 transition-all uppercase tracking-wide"
                        >
                        ...
                        <div className="text-center">
                            ...
                            >
                                Problems logging in? Clear cache & reload
                            </button>
                        </div>
                    </div>
                </form>
