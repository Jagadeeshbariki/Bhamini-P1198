...
const newJSX = `    return (
        <div className="lg:h-[calc(100vh-160px)] flex flex-col gap-3 lg:overflow-hidden">
            ...
            <div className="flex-1 lg:min-h-0 flex flex-col lg:flex-row gap-3 overflow-y-auto lg:overflow-hidden">
                {/* Left Column: Charts */}
                ...
                {/* Right Column: Table */}
                <div className="lg:w-1/3 w-full bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col min-h-[300px] lg:min-h-0">
                    <h3 className="text-xs font-black uppercase tracking-widest text-gray-800 mb-3 shrink-0">Forms</h3>
                    <div className="flex-1 overflow-auto pr-2 custom-scrollbar lg:h-auto h-[300px]">
...
console.log("Updated layout for mobile");
